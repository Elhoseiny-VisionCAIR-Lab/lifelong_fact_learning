...
try:
    ...
    model_name = 'mas_objective_8tasks_{}_reg{}_lr{:.0e}_epochs{}{}'.format(split, reg_lambda, base_lr, epochs, batch_str) + tv
except TypeError as e:
    base_lr = None
    lr=None
    model_name= 'mas_objective_8tasks_{}_reg{}_lr_def_epochs{}{}'.format(split, reg_lambda, epochs, batch_str) + tv
...
def train_task(task_num):
    ...
    if task_num == 1:
        ...
        reg_sets = ['/splits/8tasks_{}/B{}_train.csv'.format(split, task_num - 1)]
        if trainval:
            reg_sets.append('/splits/8tasks_{}/B{}_test.csv'.format(split, task_num - 1))
