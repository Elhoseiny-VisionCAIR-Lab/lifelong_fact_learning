...
try:
    ...
    model_name = 'mas_8tasks_{}_reg{}_lr{:.0e}_epochs{}{}'.format(split, reg_lambda, base_lr, epochs, batch_str) + tv
except TypeError as e:
    base_lr = None
    lr=None
    model_name= 'mas_8tasks_{}_reg{}_lr_def_epochs{}{}'.format(split, reg_lambda, epochs, batch_str) + tv
