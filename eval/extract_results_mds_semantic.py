...
tembedding_path='/Users/sherifabdelkarim/projects/lifelong_learning_raw_files/eval/MDS/MD_semantic_eval/Temb_MD_semantic/'
...
for model_name in model_names:
    if '4tasks_semantic' in model_name:
        ...
        for b in range(1, 5):
            ...
            res_name= root + '/results/mds_results/semantic/' + model_name + '_batch' + str(b) + '_m1_nodup.mat'
