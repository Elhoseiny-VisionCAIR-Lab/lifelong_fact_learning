...
for model_name in model_names:
    if '8tasks_random' in model_name:
        ...
        for b in range(1, 9):
            ...
            T_embedding=scipy.io.loadmat(root + '/random_eval/TEmbedding_rnd_B' + str(b) + '_test.mat')
            T_embedding=T_embedding['B_T']
            TestData=scipy.io.loadmat(root +'/random_eval/TestData_rnd_B' + str(b) + '_test.mat')
