...
tembedding_path= root + 'eval/eval_files/TEmbeddings/mid_scale/random/Temb_MD_random/'
...
for model_name in model_names:
    if '4tasks_random' in model_name:
        ...
        for b in range(1, 5):
            ...
            res_name= root + '/eval/results/mds_results/random/' + model_name + '_batch' + str(b) + '_m1_nodup.mat'
